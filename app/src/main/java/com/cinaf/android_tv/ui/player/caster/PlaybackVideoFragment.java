...
import com.cinaf.android_tv.data.models.Playlist;
import com.cinaf.android_tv.data.models.Poster;
import com.cinaf.android_tv.data.models.Source;
import com.cinaf.android_tv.ui.detail.PersonPresenter_casting;
import com.cinaf.android_tv.ui.main.MainActivity;
import com.cinaf.android_tv.ui.main.MovieRow;
import com.cinaf.android_tv.ui.movie.CardRelatedVideoPresenter;
...
public class PlaybackVideoFragment extends VideoSupportFragment{
    ...
    private static Poster convertLoadRequestToMovie(MediaLoadRequestData loadRequestData) {
        ...
        Log.w("TAG1", "88888888888888888888888888888: " + videoUrl);
        MediaMetadata metadata = mediaInfo.getMetadata();
        Poster poster = new Poster();
        poster.setSources(poster.getSources());
    ...
    public void onStart() {
        ...
        Log.w("TAG2", "myFillMediaInfo4444444444444444: " + mMediaSession.getSessionToken());
    ...
    public void onError(int errorCode, CharSequence errorMessage) {
        ...
        intent.putExtra("url", poster.getSources().get(0).getUrl());
        startActivity(intent);
    }
    ...
    private void startPlayback(Poster poster, long startPosition) {
        ...
        if (!poster.getSources().isEmpty()) {
            Log.w("TAG1", "MOUNOK2222: " + poster.getSources().get(0).getUrl());
            prepareMediaForPlaying(Uri.parse(poster.getSources().get(0).getUrl()));
    ...
    private void myFillMediaInfo(MediaInfoWriter mediaInfoWriter) {
        ...
        Log.w("TAG2", "myFillMediaInfo00000000000000000: ");
        if (mediaInfo.getContentUrl() == null && mediaInfo.getEntity() != null) {
            Log.w("TAG2", "myFillMediaInfo1111111111111111111111: ");
            // Load By Entity
            ...
            mediaInfoWriter.setContentUrl(poster.getSources().get(0).getUrl()).setMetadata(movieMetadata);
        }
    }
    ...
    class MyMediaMetadataProvider implements MediaMetadataProvider {
        ...
        public MediaMetadataCompat getMetadata(Player player) {
            ...
            if (playingMovie != null) {
                ...
                mediaMetadata.putString(
                        MediaMetadataCompat.METADATA_KEY_MEDIA_URI, playingMovie.getSources().get(0).getUrl());
